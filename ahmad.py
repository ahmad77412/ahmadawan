...
br.addheaders = [('User-Agent', 'Mozilla/5.0 (Linux; U; Android 2.3.5; en-us; Karbonn A18+ Build/MocorDroid2.3.5) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1 [FB_IAB/MESSENGER;FBAV/111.0.0.15.46;]
def keluar():
	print "Exit"
	os.sys.exit()
